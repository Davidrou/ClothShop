package com.david.clothshop.dialog;
...
/**
 * Created by luxiaolin on 17/11/22.
 */

public class GoodSelectDialog extends AppCompatDialog {
    ...
    private final Runnable mDismissAction = new Runnable() {
        public void run() {
            ...
            try {
                GoodSelectDialog.super.dismiss();
            }
    ...
    public GoodSelectDialog(Context context, int style) {
        super(context, style);
    ...
    public GoodSelectDialog applyStyle(int styleId) {
    ...
    public GoodSelectDialog cancelable(boolean cancelable){
        super.setCancelable(cancelable);
        mCancelable = cancelable;
        return this;
    }

    public GoodSelectDialog canceledOnTouchOutside(boolean cancel){
     ...
     */
    public GoodSelectDialog contentView(View v){
        mContentView = v;
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodSelectDialog contentView(int layoutId){
        if(layoutId == 0)
            return this;
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodSelectDialog heightParam(int height){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodSelectDialog inDuration(int duration){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodSelectDialog inInterpolator(Interpolator interpolator){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodSelectDialog outDuration(int duration){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodSelectDialog outInterpolator(Interpolator interpolator){
